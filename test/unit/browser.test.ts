...
import { Browser, Condition, Configuration, Driver, Element, have } from '../../lib';
...
Describe('Browser', () => {
    ...
    beforeEach(() => {
       selenideDriver = Browser.selenideDriver;
       configuration = Browser.configuration;
    });

    afterEach(() => {
        Browser.selenideDriver = selenideDriver;
    ...
    It('open should call driver.open with correct arguments', async () => {
        ...
        Browser.selenideDriver = driverMock as any;
    ...
    It('close should call driver.close', async () => {
        ...
        Browser.selenideDriver = driverMock as any as any;
